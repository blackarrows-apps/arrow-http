...
fun PatchJsonScreen(
    ...
    var title by remember { mutableStateOf("Patched Title") }
    var body by remember { mutableStateOf("This is a patched post body") }
    ...
    Scaffold(
        ...
        Column(
            ...
            Text(
                text = "Update an existing post using PATCH",
                ...
                onClick = {
                    scope.launch {
                        ...
                        postId.toIntOrNull()?.let { id ->
                            repository.patchPost(id, title, body)
                                .onSuccess { post ->
                                    result = "Success! Patched post ${post.id}\n\n" +
                                            "Title: ${post.title}\n" +
                                            "Body: ${post.body}"
                                }
                                .onFailure { e ->
